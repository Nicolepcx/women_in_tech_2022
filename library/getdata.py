...
class GetData(Dataset):
    ...
    def __init__(self, T_w,filepath, subset='train', smooth_window=0):
      ...
      :param T_w: Time window (int) for the time series e.g. 96 observations
      :param filepath: path to the data
      :param subset: subset of the data e.g. "train" or "test"
      :param smooth_window: the window for the moving average smoothing (int) e.g. 20
      """
